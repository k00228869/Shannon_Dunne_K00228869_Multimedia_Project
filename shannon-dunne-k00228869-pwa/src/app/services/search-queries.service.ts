...
export class SearchQueriesService {
  ...
  public checkQuery(location: string, busType: string, sort: string): Observable<IUser['business'][]>
  {
    ...
    else if (sort === 'price' && location !== 'default' && busType !== 'default')
    {
      this.filteredProfiles = [];
    ...
    else if (sort === 'default' && location !== 'default' && busType !== 'default'){
      this.filteredProfiles = [];
    ...
    else if (sort === 'default' && busType === 'default' && location !== 'default'){
      this.filteredProfiles = [];
    ...
    else if (sort === 'price' && busType === 'default' && location !== 'default'){
      this.filteredProfiles = [];
    ...
    else if (sort === 'rating' && busType === 'default' && location !== 'default'){
      this.filteredProfiles = [];
